    ...
    m_workerThread(NULL)
{
    ...
    ui->checkBox_physicalFormat->setVisible(false);
...
void OptionDialog::ReInitItems()
{
    ...
    ui->checkBox_physicalFormat->setVisible(isPhysicalRBFMTVisible);
...
void OptionDialog::ShowCustomDLTheme(bool show)
{
    ui->label_dlScene->setVisible(show);
    ui->groupBox_dlScene->setVisible(show);
}
